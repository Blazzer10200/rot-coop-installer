...
function Get-DependencySpec {
    @(
        ...
        @{ Name='MCM';           Module='Bannerlord.MBOptionScreen'; KeyDll='MCMv5.dll';                   Extra=$null;                 Why='In-game mod settings menu. Optional but recommended.';    Nexus='https://www.nexusmods.com/mountandblade2bannerlord/mods/612';  Optional=$true }
